...
public interface IForeignService extends IBaseService {
    ...
    Result FindOrgCode(String pospCode, String orgCode, Object companyId, Object sectionId, Integer pageNum, Integer pageSize);
    ...
    Result newFindOrgCodeConfirm(String pospCode, String orgCode, Object companyId, Object sectionId, String idStr);
